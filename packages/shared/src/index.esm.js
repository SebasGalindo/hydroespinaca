...
const useActuatorStore = create((set, get) => ({
    // Estado inicial
    actuadores: [],
    // Acciones
...
const useFuzzyStore = create((set, get) => ({
    // State
    fuzzySystems: [],
    fuzzyVariables: [],
    fuzzyTerms: [],
...
const ProtectedRoute = ({ children, fallback, redirectTo = '/login' }) => {
    ...
    if (isLoading) {
        return (jsx("div", { style: {
                ...
                alignItems: 'center',
                height: '100vh'
            }, children: jsx("div", { children: "Cargando..." }) }));
    }
    ...
    if (!isAuthenticated) {
        ...
        return (jsx("div", { style: {
                ...
                alignItems: 'center',
                height: '100vh'
            }, children: jsx("div", { children: "Redirigiendo al login..." }) }));
    }
...
...props }) => {
    ...
    return (jsx("svg", { width: size, height: size, viewBox: "0 0 24 24", fill: fill, stroke: stroke || color, strokeWidth: strokeWidth, strokeLinecap: "round", strokeLinejoin: "round", ...props, children: jsx("path", { d: pathData }) }));
};
...
export { ApiError, AuthApiService, CHART_VARIABLES, Icon, ProtectedRoute, SessionStorage, authService$1 as authService, baseTokens, borderRadius, colors, componentSpacing, createActuator, createVariable, deleteActuator, deleteVariable, detectPlatform, drawerMenuConfig, elevation, fetchActuators, fetchIndividualReadings, fetchMetrics, fetchSensorData, fetchSensorSummary, fetchVariables, formatCurrency, formatDate, formatSensorValue, getApiUrl, getAppInfo, getDrawerMenuItem, getExpandableItems, getItemsWithStatus, getMainTabs, getNavigationItem, getWelcomeMessage, isDevelopmentMode, isFutureDate, isValidEmail, isValidSensorValue, navigationConfig, secureStorage, semanticColors, spacing, svgPaths, textStyles, truncateText, typography, updateActuator, updateVariable, useActuatorStore, useAlertStore, useAuth, useAuthStore, useDashboardStore, useFuzzyStore, useLoginForm, useNativeAuth, useReadingsStore, useSensorStore, useVariableStore, useWebAuth, validateLoginCredentials, validatePassword, zIndex };
