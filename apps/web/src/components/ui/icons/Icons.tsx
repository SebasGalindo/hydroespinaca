...
// Nuevos iconos para el dashboard
...
export const PhIcon: React.FC<IconProps> = ({ 
  className = '', 
  size = 24, 
  color = 'currentColor' 
}) => {
...
export const ElectricIcon: React.FC<IconProps> = ({ 
  className = '', 
  size = 24, 
  color = 'currentColor' 
}) => {
...
export const SensorIcon: React.FC<IconProps> = ({ 
  className = '', 
  size = 24, 
  color = 'currentColor' 
}) => {
...
export const MotorIcon: React.FC<IconProps> = ({ 
  className = '', 
  size = 24, 
  color = 'currentColor' 
}) => {
...
export const CloudSunIcon: React.FC<IconProps> = ({
  className = '',
  size = 24,
  color = 'currentColor'
}) => {
