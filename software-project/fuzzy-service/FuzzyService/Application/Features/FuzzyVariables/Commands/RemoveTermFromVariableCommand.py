...
class RemoveTermFromVariableCommand(BaseModel, Command):
    """Command para remover un término de una variable difusa."""

    model_config = ConfigDict(validate_assignment=True, extra="forbid")

    variable_id: str = Field(..., min_length=1, description="ID de la variable")
    term_id: str = Field(..., min_length=1, description="ID del término a remover")
