...
public class RoleClaimTests : IClassFixture<IntegrationTestBase>, IDisposable
{
    ...
    [Fact]
    public async Task UserToken_ShouldHaveSimpleRoleClaim()
    {
        // Arrange
    ...
    [Fact]
    public async Task M2MToken_ShouldHaveSimpleRoleClaim()
    {
        // Arrange
        var tokenService = _testBase.Services.GetRequiredService<ITokenService>();
    ...
    [Fact]
    public async Task TokenClaims_ShouldHaveExpectedStructure()
    {
        // Arrange
        var tokenService = _testBase.Services.GetRequiredService<ITokenService>();
